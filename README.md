...
[![codecov](https://codecov.io/gh/BlokhinRoman/test/branch/main/graph/badge.svg?token=test_token_here)](https://codecov.io/gh/BlokhinRoman/test)
[![CI](https://github.com/BlokhinRoman/test/actions/workflows/main.yml/badge.svg)](https://github.com/BlokhinRoman/test/actions/workflows/main.yml)

Awesome test created by BlokhinRoman

## Install

from source
```bash
git clone https://github.com/BlokhinRoman/test test
cd test
make install
```
